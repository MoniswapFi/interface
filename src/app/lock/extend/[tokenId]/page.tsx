  ...
  return (
    <div className="p-5 pb-20">
      ...
      <div className="z-1 relative m-auto mt-32 flex max-w-[620px] flex-col gap-10">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  onValueChange={(selected) => {
                    setDuration(selected ? 126144000 : duration);
                  ...
                  classNames={{
                    ...
                    thumb:
                      "rounded-none group-data-[selected=true]:bg-btn-primary group-data-[selected=true]:ml-[22px]",
                  }}
                />
              </div>
        ...
        <Button
          onClick={() => increaseUnlockTime(Number(params.tokenId), duration)}
