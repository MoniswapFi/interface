  ...
  useEffect(() => {
    if (!!query.get("token0") && tokenLists.length > 0) {
      const token0 = tokenLists.find(
        (token) =>
          token.address.toLowerCase() === query.get("token0")!.toLowerCase(),
      );
  ...
  useEffect(() => {
    if (!!query.get("token1") && tokenLists.length > 0) {
      const token1 = tokenLists.find(
        (token) =>
          token.address.toLowerCase() === query.get("token1")!.toLowerCase(),
      );
                ...
                {tokenLists.map((token, index) => {
                  return (
                    <SelectItem
                      ...
                      onPress={() =>
                        setSelectedTokens([token, selectedTokens[1]])
                      }
                      key={index}
                      classNames={{
                ...
                {tokenLists.map((token, index) => {
                  return (
                    <SelectItem
                      ...
                      key={index}
                      onPress={() =>
                        setSelectedTokens([selectedTokens[0], token])
                      }
                      classNames={{
                        base: "data-[selectable=true]:bg-footer data-[hover=true]:bg-footer data-[hover=true]:text-white",
                      }}
          ...
          <div className="flex flex-col gap-5">
            ...
            selectedTokens[1] !== null ? (
                    ...
                    <div className="flex flex-col justify-between gap-5 lg:flex-row lg:gap-0">
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <ChipBadge>
                            Basic Stable · {Number(fee0 ?? 0) / 100}%
                          </ChipBadge>
                        </div>
                      </div>
                        ...
                        <p>
                          ...
                          {toSF(
                            stablePool.pairHourData?.findLast(
                              (p) => timeInMotion - p.hourStartUnix <= 24,
                            )?.hourlyVolumeUSD,
                          )}
                        </p>
                      </div>
                    ...
                    <div className="flex flex-col justify-between gap-5 lg:flex-row lg:gap-0">
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <ChipBadge>
                            Basic Volatile · {Number(fee1 ?? 0) / 100}%
                          </ChipBadge>
                        </div>
                      </div>
              ...
              <div className="flex gap-3 bg-footer px-5 py-3 text-textgray md:items-center">
                ...
                There are no available liquidity pools. Try supplying liquidity
                to low LPs.
              </div>
            )}
          </div>
            ...
            <div className="flex w-full flex-col gap-2">
              ...
              selectedTokens[1] !== null ? (
                        ...
                        <div className="flex flex-col justify-between gap-5 lg:flex-row lg:gap-0">
                          <div className="flex items-center">
                            ...
                            <div>
                              ...
                              <ChipBadge>
                                Basic Stable · {Number(stableFee ?? 0) / 100}%
                              </ChipBadge>
                            </div>
                          </div>
                ...
                <div className="flex gap-3 bg-footer px-5 py-3 text-textgray md:items-center">
                  ...
                  There are no available low LPs. Add to available ones instead.
                </div>
              )}
            </div>
          </div>
