        ...
        <div className="flex w-full gap-5">
            <div className="w-[40%]">
                <div className="relative flex w-full items-center gap-1">
                    ...
                    <div className="">
                        ...
                        <div className="text-xs">
                            <span className="text-lightblue">
                                ...
                                {toSF(
                                    Number(
                                        pair.stable ? stableFee : volatileFee,
                                    ) / 100,
                                )}
                                %{" "}
                            </span>
                    ...
                    <button
                        onClick={() =>
                            dispatch(deselectPoolFromVoting(pair.id))
                        }
                ...
                <div className="grid grid-cols-2 text-sm">
                    <div className="flex flex-col justify-center gap-1 px-3 text-right">
                        ...
                        <p className="text-gray1">
                            {toSF(
                                formatUnits(BigInt(weight[pair.id] ?? 0), 18),
                            )}{" "}
                            veMONI
                        </p>
                    </div>
                                ...
                                <div className="relative flex items-center justify-between bg-nightRider p-3">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="space-y-2">
                                            <p className="text-lg">
                                                Lock ID {lock.tokenId}
                                            </p>
                                            <p className="text-sm text-gray1">
                                                {toSF(lock.amountLocked)} MONI
                                                locked for{" "}
                                                {toSF(
