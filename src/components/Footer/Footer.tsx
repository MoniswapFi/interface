    ...
    <div className="bg-footer px-10 py-5">
      <div className="flex items-end justify-between pb-[35px] md:items-start md:pb-[55px]">
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:gap-5">
          <Link href={"https://docs.moniswap.xyz/"}>Documentation</Link>
          <Link href={"https://docs.moniswap.xyz/audits"}>Security</Link>
          <Link href={"https://docs.moniswap.xyz/media-kit"}>Brand Kit</Link>
